...
$page_en=array(
  ...
  'content'=>'<h4>Instituto Suizo de Gastronomía y Hotelería  (ISU)</h4>
  			  ...
  			  <p>El reconocimiento consiste en la asignación de becas la cual se realiza con base en los resultados de la evaluación de los alumnos de 5o semestre, a quienes se les aplica un examen diagnóstico en las áreas de verbal, matemáticas y de redacción indirecta (PAA).  El puntaje máximo del examen diagnostico es de 2,400 puntos.</p>
  			  <ul class="margin-15">
				<li><b>Beca de Excelencia </b><br>
				90% al mejor promedio de la generación (no transferible).</li>
				...
				2251 - 2400 Promedio de Generación PAA  –  una beca del 80% pura</li>
  			  ...
  			  <p>Para todos aquellos alumnos con promedio acumulado de 8.0 como mínimo al término de sus estudios de preparatoria o equivalente:</p>
  			  <ol class="margin-15">
